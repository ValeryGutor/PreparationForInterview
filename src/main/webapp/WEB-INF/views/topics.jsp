...
<head>
    <meta charset="UTF-8">
    <title>Topics of interview questions</title>
    ...
    <table class="rules">
        ...
        <c:forEach items="${topics}" var="topic">
            <tr class="record">
                ...
                <td><a href="<c:url value="/showTopicQuestion${topic.id}"/>"> View list of questions </a></td>
                <td class="last">
            ...
            <tr class="companion">
                <td class="output" colspan="7">
                    <p>
                        <%--${topic.description}--%>
                        <%--Here will be the description of topic;--%>
                    </p>
                </td>
            </tr>
        </c:forEach>
